...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="text" wire:model.live="customValues.transport_routes.<?php echo e($index); ?>.departure_time" placeholder="Ex: 09:30 / Hikari 502" style="width: 100%; padding: 0.45rem 0.5rem; border: 1px solid #cbd5e1; border-radius: 0.375rem; font-size: 0.8rem; background: #ffffff;" />
                                                    </div>

                                                    <div>
                                                        <label style="font-size: 0.75rem; font-weight: 700; color: #374151; display: block; margin-bottom: 0.2rem;">Classe / Option</label>
                                                        <select wire:model.live="customValues.transport_routes.<?php echo e($index); ?>.option_id" style="width: 100%; padding: 0.45rem 0.4rem; border: 1px solid #cbd5e1; border-radius: 0.375rem; font-size: 0.8rem; background: #ffffff; color: #1e293b; font-weight: 600;">
